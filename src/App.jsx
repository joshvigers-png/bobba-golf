...
function HomeScreen({ user, onOpenModule, onLogout, onReviewRound, onOpenProfile }) {
  ...
  const modules = [
    ...
    { id: "community",   label: "The Lounge", sub: "Talk & connect", icon: <Icon.ModLounge />, ready: true },
    { id: "tournaments", label: "Competition Mode", sub: "Live leaderboards", icon: <Icon.ModTrophy />, ready: true },
